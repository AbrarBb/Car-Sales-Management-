...
public class Main 
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        try {
            ...
            //test admin
            Admin admin1 = new Admin("Lajim", "admin", "Lajim", "Badda", "2022-3-60-043@std.ewubd.edu", "018392289**");
            Admin admin2 = new Admin("Jisan", "1234", "Mehedi Jisan", "Puran Dhaka", "2022-3-60-012@std.ewubd.edu", "0183324329**");
            Admin admin3 = new Admin("Enam", "12345", "Enam Ahamad", "Banasree", "2023-3-60-011@std.ewubd.edu", "0183324289**");
            Admin admin4=new Admin("TM", "121", "Tanni Mittra", "Dhaka", "tanni@ewubd.edu", "01833289**");
            ...
            //test customer
            Customer cus1 = new Customer(11, "Provat", "DIT,Project", "60-317@std.ewubd.edu", "019194264");
            ...
            // MAIN MENU
            System.out.println("-----------------------------------------------------------------------------");
            System.out.println("                       Welcome to Dynasty Car Store   ");
            System.out.println("");
            System.out.println("                           Pay more , Get low! ");
            System.out.println("-----------------------------------------------------------------------------");
            while (true) 
            {
